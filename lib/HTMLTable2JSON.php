...
class HTMLTable2JSON {
	...
	public function tableToJSON($outfile, $url, $firstColIsRowName = TRUE, $tableID = '', $ignoreCols = NULL, $headers = NULL, $firstRowIsData = FALSE, $onlyColumns = FALSE, $arrangeByRow = FALSE, $ignoreHidden = FALSE, $printJSON = TRUE, $testingTable = NULL) {
		$ignoring = FALSE;
		$excluding = FALSE;
		if (NULL != $onlyColumns){
